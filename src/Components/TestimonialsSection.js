  ...
  return (
    <div className="relative w-full">
      ...
      <img
        src="/images/leaf.svg"
        alt="Decorative leaf"
        className="absolute top-[80px] left-0 w-60 h-60 z-10 hidden lg:block"
      />
      <img
        src="/images/leaf.svg"
        alt="Decorative leaf"
        className="absolute bottom-[-50px] right-[10px] z-10 w-48 h-48 hidden lg:block"
      />
      {/* Testimonials Section */}
      <div className="container mx-auto px-4 md:px-8 py-10 md:py-20 grid grid-cols-1 md:grid-cols-2 gap-10 md:gap-20 bg-[#FFFFFF]">
        {testimonials.map((testimonial, index) => (
          <div key={index} className="relative w-full md:w-[460px] h-auto md:h-[400px] bg-[#004C4C] p-6 md:p-10 rounded-lg mx-auto">
            ...
            <div className="absolute -right-2 md:-right-4 -top-2 md:-top-4 w-[100px] md:w-[148px] h-[120px] md:h-[160px] bg-[#FFFFFF] p-4 rounded-lg flex justify-center items-center">
              <svg
                width="80"
                height="80"
                viewBox="0 0 32 32"
            ...
            <div className="flex flex-col h-full">
              ...
              <div className="flex-1">
                <p className="text-white text-[20px] md:text-[28px] leading-snug md:leading-9 font-extrabold font-lato pr-16 md:pr-24">
                  {testimonial.text}
                </p>
                <div className="flex items-end justify-between">
                  <p className="text-[#FFC12D] text-xl md:text-3xl font-extrabold font-lato mt-4">
                  ...
                  <div className="flex-shrink-0 ml-2">
                    <img
                      ...
                      className="w-16 h-16 md:w-20 md:h-20 rounded-2 object-cover"
                    />
                  </div>
                </div>
              </div>
