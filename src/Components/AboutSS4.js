      ...
      <div className="mt-12 md:mt-8 w-full">
        <div className="flex flex-col lg:flex-row items-start lg:items-stretch gap-8 lg:gap-6">
          <div className="border-l-6 border-[#FFC12D] pl-4 py-2">
            <h3 className="text-[#004C4C] text-2xl md:text-[32px] font-bold border-l-[6px] border-yellow-400 pl-4 mb-8">
              Our 3-Step
            ...
            <img
              ...
              alt="Pathway"
              className="h-full w-full md:h-8 mt-2"
            />
          </div>

          <div className="grid grid-cols-1 md:grid-cols-3 lg:flex gap-8 lg:gap-6 flex-grow lg:w-64">
            {[
              {
                number: 1,
                title: 'Explore:',
              ...
              <div
                key={index}
                className="relative border-[5px] border-[#004C4C] rounded-lg p-4 w-full"
              >
                ...
                <div className="flex flex-col h-full">
                  ...
                  <p
                    className="font-lato text-black  text-lg md:text-xl lg:text-[24px] leading-snug md:leading-[29px]"
                    style={{ fontFamily: 'Lato' }}
                  >
                    {item.text}
                  </p>
