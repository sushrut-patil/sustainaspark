...
const CountdownTimer = ({ deadline = "2025-01-05T00:00:00" }) => {
  ...
  return (
    <div className="w-full flex justify-center">
      <div style={{ background: '#004C4C' }} className="inline-flex text-white p-4 md:p-6 rounded-lg font-mono gap-2 md:gap-4 flex-wrap md:flex-nowrap text-sm md:text-2xl border-[16px] border-white relative">
        ...
        <div className="text-3xl md:text-5xl font-bold relative z-10">:</div>
        <div className="text-center relative z-10">
